 ...
 */
public class PuzzleThreeFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prepareData();
        vParent = inflater.inflate(R.layout.fragment_puzzle_three, container, false);
        fetchLayout();
        tvQuestion.setText("");
    ...
    private void fetchLayout() {
        ...
        TableLayout board = vParent.findViewById(R.id.puzzle_three_board);
...
//        ArrayList<Integer> neighbours = helper.findBoxNeighbour(pos[0], pos[1]);
    ...
    private void prepareData() {
        ...
        String[] question = getResources().getStringArray(R.array.soal_tts_3),
                key = getResources().getStringArray(R.array.kunci_tts_3);

        ArrayList<CrossWord> listWord = new ArrayList<>();
        int i = 0;
        CrossWord crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_1a, R.id.puzzle_three_tv_box_2b,
                        R.id.puzzle_three_tv_box_3a, R.id.puzzle_three_tv_box_4a,
                        R.id.puzzle_three_tv_box_5b, R.id.puzzle_three_tv_box_6b,
                        R.id.puzzle_three_tv_box_7b, R.id.puzzle_three_tv_box_8c,
                        R.id.puzzle_three_tv_box_9h, R.id.puzzle_three_tv_box_10c,
                        R.id.puzzle_three_tv_box_11c, R.id.puzzle_three_tv_box_12c,
                        R.id.puzzle_three_tv_box_13b, R.id.puzzle_three_tv_box_14b,
                        R.id.puzzle_three_tv_box_15a, R.id.puzzle_three_tv_box_16d,
                        R.id.puzzle_three_tv_box_17a
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_2a, R.id.puzzle_three_tv_box_2b,
                        R.id.puzzle_three_tv_box_2c, R.id.puzzle_three_tv_box_2d,
                        R.id.puzzle_three_tv_box_2e, R.id.puzzle_three_tv_box_2f
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_5a, R.id.puzzle_three_tv_box_6a,
                        R.id.puzzle_three_tv_box_7a, R.id.puzzle_three_tv_box_8a,
                        R.id.puzzle_three_tv_box_9a, R.id.puzzle_three_tv_box_10a,
                        R.id.puzzle_three_tv_box_11a, R.id.puzzle_three_tv_box_12a,
                        R.id.puzzle_three_tv_box_13a, R.id.puzzle_three_tv_box_14a
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_5c, R.id.puzzle_three_tv_box_6c,
                        R.id.puzzle_three_tv_box_7c, R.id.puzzle_three_tv_box_8d,
                        R.id.puzzle_three_tv_box_9j
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_8b, R.id.puzzle_three_tv_box_9e,
                        R.id.puzzle_three_tv_box_10b, R.id.puzzle_three_tv_box_11b,
                        R.id.puzzle_three_tv_box_12b
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_9a, R.id.puzzle_three_tv_box_9b,
                        R.id.puzzle_three_tv_box_9c, R.id.puzzle_three_tv_box_9d,
                        R.id.puzzle_three_tv_box_9e, R.id.puzzle_three_tv_box_9f,
                        R.id.puzzle_three_tv_box_9g, R.id.puzzle_three_tv_box_9h,
                        R.id.puzzle_three_tv_box_9i, R.id.puzzle_three_tv_box_9j,
                        R.id.puzzle_three_tv_box_9k
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_three_tv_box_11d, R.id.puzzle_three_tv_box_12d,
                        R.id.puzzle_three_tv_box_13c, R.id.puzzle_three_tv_box_14c,
                        R.id.puzzle_three_tv_box_15b, R.id.puzzle_three_tv_box_16j
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i],
                new int[]{
                        R.id.puzzle_three_tv_box_16a, R.id.puzzle_three_tv_box_16b,
                        R.id.puzzle_three_tv_box_16c, R.id.puzzle_three_tv_box_16d,
                        R.id.puzzle_three_tv_box_16e, R.id.puzzle_three_tv_box_16f,
                        R.id.puzzle_three_tv_box_16g, R.id.puzzle_three_tv_box_16h,
                        R.id.puzzle_three_tv_box_16i, R.id.puzzle_three_tv_box_16j
                });
        listWord.add(crossWord);
