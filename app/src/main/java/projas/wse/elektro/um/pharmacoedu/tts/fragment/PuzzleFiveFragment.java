 ...
 */
public class PuzzleFiveFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prepareData();
        vParent = inflater.inflate(R.layout.fragment_puzzle_five, container, false);
        fetchLayout();
        tvQuestion.setText("");
    ...
    private void fetchLayout() {
        ...
        TableLayout board = vParent.findViewById(R.id.puzzle_five_board);
...
//        ArrayList<Integer> neighbours = helper.findBoxNeighbour(pos[0], pos[1]);
    ...
    private void prepareData() {
        ...
        String[] question = getResources().getStringArray(R.array.soal_tts_5),
                key = getResources().getStringArray(R.array.kunci_tts_5);

        ArrayList<CrossWord> listWord = new ArrayList<>();
        int i = 0;
        CrossWord crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_1a, R.id.puzzle_five_tv_box_2a,
                        R.id.puzzle_five_tv_box_3a, R.id.puzzle_five_tv_box_4a,
                        R.id.puzzle_five_tv_box_5a, R.id.puzzle_five_tv_box_6b,
                        R.id.puzzle_five_tv_box_7f
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_1b, R.id.puzzle_five_tv_box_2b,
                        R.id.puzzle_five_tv_box_3b, R.id.puzzle_five_tv_box_4b,
                        R.id.puzzle_five_tv_box_5b, R.id.puzzle_five_tv_box_6c,
                        R.id.puzzle_five_tv_box_7k
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_2c, R.id.puzzle_five_tv_box_3c,
                        R.id.puzzle_five_tv_box_4f, R.id.puzzle_five_tv_box_5c,
                        R.id.puzzle_five_tv_box_6d, R.id.puzzle_five_tv_box_7m,
                        R.id.puzzle_five_tv_box_8b, R.id.puzzle_five_tv_box_9b,
                        R.id.puzzle_five_tv_box_10d, R.id.puzzle_five_tv_box_11l,
                        R.id.puzzle_five_tv_box_12d, R.id.puzzle_five_tv_box_13f
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_4b, R.id.puzzle_five_tv_box_4c,
                        R.id.puzzle_five_tv_box_4d, R.id.puzzle_five_tv_box_4e,
                        R.id.puzzle_five_tv_box_4f
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_5d, R.id.puzzle_five_tv_box_6e,
                        R.id.puzzle_five_tv_box_7n, R.id.puzzle_five_tv_box_8c,
                        R.id.puzzle_five_tv_box_9c, R.id.puzzle_five_tv_box_10e,
                        R.id.puzzle_five_tv_box_11m, R.id.puzzle_five_tv_box_12e,
                        R.id.puzzle_five_tv_box_13i, R.id.puzzle_five_tv_box_14b,
                        R.id.puzzle_five_tv_box_15a, R.id.puzzle_five_tv_box_16a
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_6a, R.id.puzzle_five_tv_box_7c,
                        R.id.puzzle_five_tv_box_8a, R.id.puzzle_five_tv_box_9a,
                        R.id.puzzle_five_tv_box_10a, R.id.puzzle_five_tv_box_11a,
                        R.id.puzzle_five_tv_box_12a, R.id.puzzle_five_tv_box_13a
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_7a, R.id.puzzle_five_tv_box_7b,
                        R.id.puzzle_five_tv_box_7c, R.id.puzzle_five_tv_box_7d,
                        R.id.puzzle_five_tv_box_7e, R.id.puzzle_five_tv_box_7f,
                        R.id.puzzle_five_tv_box_7g, R.id.puzzle_five_tv_box_7h,
                        R.id.puzzle_five_tv_box_7i, R.id.puzzle_five_tv_box_7j,
                        R.id.puzzle_five_tv_box_7k, R.id.puzzle_five_tv_box_7l
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_10b, R.id.puzzle_five_tv_box_11c,
                        R.id.puzzle_five_tv_box_12b, R.id.puzzle_five_tv_box_13b,
                        R.id.puzzle_five_tv_box_14a
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_10c, R.id.puzzle_five_tv_box_11f,
                        R.id.puzzle_five_tv_box_12c
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i++],
                new int[]{
                        R.id.puzzle_five_tv_box_11b, R.id.puzzle_five_tv_box_11c,
                        R.id.puzzle_five_tv_box_11d, R.id.puzzle_five_tv_box_11e,
                        R.id.puzzle_five_tv_box_11f, R.id.puzzle_five_tv_box_11g,
                        R.id.puzzle_five_tv_box_11h, R.id.puzzle_five_tv_box_11i,
                        R.id.puzzle_five_tv_box_11j, R.id.puzzle_five_tv_box_11k,
                        R.id.puzzle_five_tv_box_11l
                });
        listWord.add(crossWord);
        crossWord = new CrossWord(question[i], key[i],
                new int[]{
                        R.id.puzzle_five_tv_box_13c, R.id.puzzle_five_tv_box_13d,
                        R.id.puzzle_five_tv_box_13e, R.id.puzzle_five_tv_box_13f,
                        R.id.puzzle_five_tv_box_13g, R.id.puzzle_five_tv_box_13h,
                        R.id.puzzle_five_tv_box_13i, R.id.puzzle_five_tv_box_13j
                });
        listWord.add(crossWord);
